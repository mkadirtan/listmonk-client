...
type Bounce struct {
	Results []BounceResultsInner `json:"results,omitempty"`
}
...
// SetResults gets a reference to the given []BounceResultsInner and assigns it to the Results field.
